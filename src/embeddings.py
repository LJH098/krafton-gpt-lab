...
class InputEmbedding(nn.Module):
    ...
    def __init__(
        ...
        self.position_embedding_layer = nn.Embedding(context_length, emb_dim)
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        position_embedding = self.position_embedding_layer(torch.arange(seq_len, device=x.device))
